...
// When we visit different urls, the switch statement call on dffernet functions.
switch (url_parts.pathname) {
	...
	case '/portfolio':
		...
		break;
	case '/edit':
	// node.js' equivalent to console.log but it didn't work... maybe because epress server is not installed?
